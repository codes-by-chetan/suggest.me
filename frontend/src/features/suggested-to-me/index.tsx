...
const SuggestedToMe = () => {
  ...
  return (
    <main className='relative mx-auto w-full px-4 pt-0 pb-[10vh] sm:px-6 lg:px-8'>
      <div className='py-6'>
      ...
      {showCommentBox && (
        <div
          ref={commentBoxRef}
          className='bg-background border-border fixed z-[1000] w-80 rounded-lg border shadow-lg'
          style={{
