...
const EditProfile: React.FC = () => {
  ...
  const loadProfile = useCallback(async () => {
    try {
      ...
      const validContentTypes = (
        profile.preferences?.preferredContentTypes || []
  ...
  const onSubmit = useCallback(async (data: ProfileFormData) => {
    try {
      const _userId = '507f1f77bcf86cd799439011'; // Replace with auth context
  ...
  const contentTypes = useMemo<ContentType[]>(
          ...
          <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
            ...
            <div className='space-y-2'>
              ...
              <div className='space-y-4'>
                {/* Favorite Genres */}
                <div>
                  <Label htmlFor='preferences.favoriteGenres'>
                    Favorite Genres
                  </Label>
                  <Input
                  ...
                  <div className='space-y-2'>
                    {contentTypes.map((type) => (
                      <div key={type} className='flex items-center space-x-2'>
                        ...
                        />
                        <Label htmlFor={`preferredContentTypes-${type}`}>
                          {type}
                        </Label>
                      </div>
                    ))}
